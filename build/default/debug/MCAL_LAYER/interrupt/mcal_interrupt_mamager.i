...
# 33 "MCAL_LAYER/interrupt/mcal_interrupt_mamager.c"
void __attribute__((picinterrupt(("")))) InterruptManger (void){
    ...
    if ((1 == INTCONbits.INT0IE)&&(1 == INTCONbits.INT0IF)){
     ...
     if ((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB4 == HIGH)){
        RB4_ISR();
    }

    if ((1 == INTCONbits.RBIE)&&(1 == INTCONbits.RBIF)&&(PORTBbits.RB4 == LOW)){
        RB4_ISR();
    }
